...
Abra uma janela de terminal, arraste o arquivo do instalador para ela e aperte enter. Isso deve iniciar o instalador no seu terminal.
...
![prévia do launcher após a instalação](/assets/preview2)

- Não se esqueça de alocar memória o suficiente para o modpack!
é recomendado entre 3gb e 4gb de ram.
![prévia do botão de editar instância](/assets/preview3)
![prévia da alocação de memória](/assets/preview4)
...
![troubleshooting step 1](/assets/preview6)

2- Mude o nome da instância para `Paia's Pack`
![troubleshooting step 2](/assets/preview7)

3- Crie uma pasta separada para a instância
![troubleshooting step 3](/assets/preview8)

4- Mude a versão para Fabric 1.21.1
![troubleshooting passo 4](/assets/preview9)
![troubleshooting passo 5](/assets/preview10)

5- Troque o último argumento da JVM para false
![troubleshooting passo 6](/assets/preview11)
![troubleshooting passo 7](/assets/preview12)
![troubleshooting passo 8](/assets/preview13)
